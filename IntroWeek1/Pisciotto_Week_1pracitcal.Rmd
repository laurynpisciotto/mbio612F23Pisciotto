...
#i dont know how to italicize things
```
...
```{r}
c(1, 2, 3, "Hi")
#above stores the values in the parentheses as the data

c(1, 2, 3, "Hi") + 1
#above is not valid, nonnumeric argument
...
```{r}
# Write you code in this cell
qplot(x_axis,y_axis, xlab = "x-axis", ylab = "y-axis", main = "Lauryns Plot")
